package devutility.external.redis.queue.stream.consumer.failed;
 ...
 */
public class StreamConsumer4FailedTest extends BaseTestForDuer {
	private JedisStreamQueueConsumerEvent consumerEvent = new StreamConsumerEvent4Failed();
	...
	public static void main(String[] args) {
		TestExecutor.run(StreamConsumer4FailedTest.class);
	}
}